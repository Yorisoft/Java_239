...
return (calc_gross_pay()- calc_state_tax(hours, rate) -calc_fed_tax(hours, rate) 
-dept_credit);
 ...
 class Assignment21 
{
    ...
    public static void main(String args[]) throws IOException
    {
		...
		//BufferedReader inData = new BufferedReader(new FileReader("Data.dat"));
        ...
        for(;;){
            ...
            JOptionPane.showMessageDialog(null,
				...
				"\n SS NUmber:\t\t"+ employee.socsec +
                "\n Hours: "+ employee.hours +
                "\n Pay Rate: "+ fmt.format(employee.rate) +
                "\n Sex: "+ employee.sex +
                "\n Age: "+ employee.age +
                "\n Status: " + (employee.active ? "Active" : "Inactive") +
                "\n Gross Pay: "+ fmt.format(employee.calc_gross_pay()) +
                "\n State Tax: "+ fmt.format(employee.calc_state_tax(employee.hours,employee.rate)) +
                "\n Federal Tax: " + fmt.format(employee.calc_fed_tax(employee.hours, employee.rate)) +
				"\n Net Pay: " + fmt.format(employee.calc_netpay(employee.hours, employee.rate, employee.dept_credit)),
